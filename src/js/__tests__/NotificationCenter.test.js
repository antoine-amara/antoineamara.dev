...
describe("NotificationCenter module: display a message into a little colored popin for N seconds", () => {
  ...
  describe("NotificationCenter", () => {
    ...
    test("it should initialize messageTimeout and get the notification center HTML element into the DOM", () => {
      ...
      expect(
        notificationCenter.domElement.classList.contains("snackbar")
      ).toBeTruthy();
  ...
  describe("_log", () => {
    ...
    test("it should be defined", () =>
      expect(notificationCenter._log).toBeDefined());
    test("it should be a function", () =>
      expect(typeof notificationCenter._log).toBe("function"));
    test("it should throw an error if the message parameter is not a string", () => {
      ...
      expect(() =>
        notificationCenter._log("Hello There !! ... General Kenobi !!")
      ).not.toThrow();
    });
  ...
  describe("_expireMessage", () => {
    ...
    test("it should be defined", () =>
      expect(notificationCenter._expireMessage).toBeDefined());
    test("it should be a function", () =>
      expect(typeof notificationCenter._expireMessage).toBe("function"));
  ...
  describe("NotificationCenter.success", () => {
    ...
    test("it should be defined", () =>
      expect(notificationCenter.success).toBeDefined());
    test("it should be a function", () =>
      expect(typeof notificationCenter.success).toBe("function"));
    test("it should throw an error if the message parameter is undefined", async () => {
      const errorMessage =
        "[NotificationCenter - success] the message is not defined or is not a string, got undefined";
    ...
    test("it should throw an error if the message parameter is not a string", async () => {
      const errorMessage =
        "[NotificationCenter - success] the message is not defined or is not a string, got number";
    ...
    test("it should add snackbar--success and snackbar__show css class to display the notification center, call _log to display the message, wait N second and delete the css class to hide the notification center", async () => {
      ...
      expect(
        notificationCenter.domElement.classList.contains("snackbar--success")
      ).toBeTruthy();
      expect(
        notificationCenter.domElement.classList.contains("snackbar__show")
      ).toBeTruthy();
      expect(notificationCenter.messageContainer.innerHTML).toEqual(
        messageToDisplay
      );
  ...
  describe("NotificationCenter.info", () => {
    ...
    test("it should be defined", () =>
      expect(notificationCenter.info).toBeDefined());
    test("it should be a function", () =>
      expect(typeof notificationCenter.info).toBe("function"));
    test("it should throw an error if the message parameter is undefined", async () => {
      const errorMessage =
        "[NotificationCenter - info] the message is not defined or is not a string, got undefined";
    ...
    test("it should throw an error if the message parameter is not a string", async () => {
      const errorMessage =
        "[NotificationCenter - info] the message is not defined or is not a string, got number";
    ...
    test("it should add snackbar--success and snackbar__show css class to display the notification center, call _log to display the message, wait N second and delete the css class to hide the notification center", async () => {
      ...
      expect(
        notificationCenter.domElement.classList.contains("snackbar--info")
      ).toBeTruthy();
      expect(
        notificationCenter.domElement.classList.contains("snackbar__show")
      ).toBeTruthy();
  ...
  describe("NotificationCenter.error", () => {
    ...
    test("it should be defined", () =>
      expect(notificationCenter.error).toBeDefined());
    test("it should be a function", () =>
      expect(typeof notificationCenter.error).toBe("function"));
    test("it should throw an error if the message parameter is undefined", async () => {
      const errorMessage =
        "[NotificationCenter - error] the message is not defined or is not a string, got undefined";
    ...
    test("it should throw an error if the message parameter is not a string", async () => {
      const errorMessage =
        "[NotificationCenter - error] the message is not defined or is not a string, got number";
    ...
    test("it should add snackbar--success and snackbar__show css class to display the notification center, call _log to display the message, wait N second and delete the css class to hide the notification center", async () => {
      ...
      expect(
        notificationCenter.domElement.classList.contains("snackbar--error")
      ).toBeTruthy();
      expect(
        notificationCenter.domElement.classList.contains("snackbar__show")
      ).toBeTruthy();
