...
describe('Fullscreen panel module: each section is transformed to a panel and each scroll action pass to the next/previous panel', () => {
  ...
  describe('FullscreenPanel constructor', () => {
    ...
    test('it should be a class (function)', () => expect(typeof FullscreenPanels).toBe('function'))
  ...
  describe('createAndInsertMenu', () => {
    test('it should be defined', () => expect(websitePanels.createAndInsertMenu).toBeDefined())
    test('it should be a function', () => expect(typeof websitePanels.createAndInsertMenu).toBe('function'))
    ...
    test('it should insert the menu, one element per section with the section name as title', () => {
      ...
      const menuItems = Array.from(document.getElementsByClassName('desktop-menu')[0].childNodes)
  ...
  describe('_updateMenuOnScroll', () => {
    ...
    test('it should be defined', () => expect(websitePanels._updateMenuOnScroll).toBeDefined())
    test('it should be a function', () => expect(typeof websitePanels._updateMenuOnScroll).toBe('function'))
    test('it should throw an error if the nbPanelToScroll is invalid (undefined or > nbTotalOfPanel)', () => {
      ...
      websitePanels.createAndInsertMenu('desktop-menu')
      expect(() => _updateMenuOnScroll(undefined, SCROLL_DIRECTIONS.down)).toThrow()
    ...
    test('it should active the n-1 element if the scroll direction is up', async () => {
      const { _updateMenuOnScroll, _scroll, SCROLL_DIRECTIONS } = websitePanels
      const waitForScroll = () => new Promise(resolve => setTimeout(() => resolve(), 1000))
      let menuItems = null
      ...
      menuItems = Array.from(document.getElementsByClassName('desktop-menu__item'))

      expect(menuItems[1].classList.contains('desktop-menu__item--active')).toBeTruthy()

      _updateMenuOnScroll(1, SCROLL_DIRECTIONS.up)

      menuItems = Array.from(document.getElementsByClassName('desktop-menu__item'))

      expect(menuItems[2].classList.contains('desktop-menu__item--active')).toBeTruthy()

    })
  })
  describe('_determineScrollDirection', () => {
    test('it should be defined', () => expect(websitePanels._determineScrollDirection).toBeDefined())
    test('it should be a function', () => expect(typeof websitePanels._determineScrollDirection).toBe('function'))
  ...
  describe('_scroll', () => {
    ...
    test('it should be defined', () => expect(websitePanels._scroll).toBeDefined())
    test('it should be a function', () => expect(typeof websitePanels._scroll).toBe('function'))
    ...
    test('it should scroll down if the scroll direction is down and update the status', async () => {
      ...
      const mainContainer = document.getElementsByClassName('website-content')[0]
      expect(websitePanels.currentPanelIndex).not.toEqual(panelIndexBeforeScroll)
      expect(websitePanels.currentPanelIndex).toEqual(panelIndexBeforeScroll + nbPanelToScroll)
    ...
    test('it should not scroll down if the current panel is the last one', async () => {
      const { _scroll, SCROLL_DIRECTIONS } = websitePanels
      const waitForScroll = () => new Promise(resolve => setTimeout(() => resolve(), 3000))
