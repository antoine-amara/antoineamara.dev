...
describe("SmoothScroll module: smooth scroll from your position to a target anchor", () => {
  ...
  describe("_extractTargetIdFromEvent", () => {
    test("it should be defined", () =>
      expect(_exractTargetFromEvent).toBeDefined());
    test("it should be a function", () =>
      expect(typeof _exractTargetFromEvent).toBe("function"));
    ...
    test("it should throw an error if the event doesn't contain a target as an href", (done) => {
      ...
      const menuElementWithoutTarget =
        document.getElementsByClassName("elmt-without-id")[0];
  ...
  describe("_getTargetPosition", () => {
    test("it should be defined", () =>
      expect(_getTargetPosition).toBeDefined());

    test("it should be a function", () =>
      expect(typeof _getTargetPosition).toBe("function"));
  ...
  describe("smoothScroll", () => {
    ...
    test("it should be a function", () =>
      expect(typeof smoothScroll).toBe("function"));
