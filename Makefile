...
YN = yarn
WEBSITE = website
DEPLOY = docker run -t --env-file ${PWD}/deploy/gcp/configs.env -v ${PWD}/deploy/gcp/:/deploy/ -v ${PWD}/dist/:/dist/ -v ${PWD}/functions:/functions/ -w /deploy/ --rm staticpack-gcp-terraform:332.0.0-alpine
FAAS = faas
